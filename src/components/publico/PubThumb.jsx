...
const PubThumb = ({ src, alt, index = 0, icon: Icon = BookOpen, className = 'thumb', onClick }) => (
  <div className={`${className}${src ? '' : ' ' + GRADS[index % GRADS.length]}`} onClick={onClick} role={onClick ? 'button' : undefined}>
